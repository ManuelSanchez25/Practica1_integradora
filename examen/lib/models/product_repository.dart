...
class ProductRepository {
  static List<dynamic> loadProducts(ProductType prodType) {
    ...
    if (prodType == ProductType.TAZAS)
      return <ProductCup>[
        ProductCup(
          productTitle: "Taza Dragon Ball",
          productDescription: "Bonita taza de porceralana.",
          productImage:
              "https://degoku.net/wp-content/uploads/2017/02/Taza-de-Goku-23.jpg",
          productColor: ProductColors.BLANCO,
          productAmount: 0,
        ),
        ProductCup(
          productTitle: "Taza Simpson",
          productDescription: "Bonita taza negra",
          productImage:
              "https://images-na.ssl-images-amazon.com/images/I/51yQPDG8ekL._AC_SX522_.jpg",
          productColor: ProductColors.BLANCO,
          productAmount: 0,
        ),
        ProductCup(
          productTitle: "Taza para peques",
          productDescription: "Bonita taza. ",
          productImage:
              "https://http2.mlstatic.com/antigua-taza-de-barney-y-sus-amigos-muy-buen-estado-plastica-D_NQ_NP_273505-MLA25027147732_082016-F.jpg",
          productAmount: 0,
        ),
        ProductCup(
          productTitle: "Taza Rex",
          productDescription: "Bonita taza animada",
          productImage:
              "https://cdn.gandhi.com.mx/media/catalog/product/cache/1/image/370x/9df78eab33525d08d6e5fb8d27136e95/5/0/5055453466052_1.jpg",
          productColor: ProductColors.BLANCO,
          productAmount: 0,
        ),
        ProductCup(
          productTitle: "Taza teletubis",
          productDescription: "Taza bonita",
          productImage:
              "https://www.merchandisingplaza.es/265752/2/Tazas-Teletubbies-Taza-Teletubbies-265752-l.jpg",
          productColor: ProductColors.BLANCO,
          productAmount: 0,
        ),
      ];
